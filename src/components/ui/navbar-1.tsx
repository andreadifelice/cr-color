...
const Navbar1 = () => {
  ...
  return (
    <motion.nav
      ...
      className="flex justify-center w-full py-6 px-4 fixed top-0 z-10000"
    >
      <div className="flex items-center justify-between px-6 bg-white rounded-full shadow-lg w-full max-w-6xl relative z-10">
        <div className="flex items-center">
          <motion.div
            className="w-20 md:w-25 mr-6"
            initial={{ scale: 0.8 }}
            animate={{ scale: 1 }}
